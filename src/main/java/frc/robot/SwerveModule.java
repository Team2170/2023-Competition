...
public class SwerveModule {
    ...
    private Rotation2d getAngle() {
        // WHY DID THIS CHANGE!!!????
        double degrees = Conversions.falconToDegrees(mAngleMotor.getSelectedSensorPosition(),
                Constants.Swerve.angleGearRatio) % 360;
    ...
    public double getDistanceMeters() {
        return Conversions.falconToMeters(mDriveMotor.getSelectedSensorPosition(), Constants.Swerve.wheelCircumference,
                Constants.Swerve.driveGearRatio);
    }
}